...
if (arrayYes.includes(guessSeattle)) {
    ...
    alert('All hair king of the losers - Age of Empires II')
}
...
if (arrayYes.includes(guessLacross)) {
    ...
    questionCorrect++;
    alert('I have never, ever played Lacross')
}
...
if (questionCorrect >= 3) {
    alert('Congratuations you got half or more right with ' +questionCorrect+ ' out of 6 wrong')
} else {
